...
export class TradeComponent implements OnInit {
  ...
  oldOwner = new FormControl('', Validators.required);
  ...
  addTransaction(form: any): Promise<any> {
    this.Transaction = {
      $class: 'org.tradenetwork.Trade',
      'newOwner': this.newOwner.value,
      'oldOwner': this.oldOwner.value,
      'car': this.car.value,
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.oldOwner) {
        formObject.oldOwner = result.oldOwner;
      } else {
        formObject.oldOwner = null;
      }
