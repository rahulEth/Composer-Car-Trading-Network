...
export class TraderComponent implements OnInit {
  ...
  traderId = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceTrader.updateParticipant(form.get('traderId').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.traderId) {
        formObject.traderId = result.traderId;
      } else {
        formObject.traderId = null;
      }
